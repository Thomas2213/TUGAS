...
<body style="background:url(nah.jpg)">
...
<div align='center'>
  <font color=black>
  <h1 style="text-align: center; font-family: sans-serif; color: white;"><font color= black>Selamat Datang</font> <?php echo $level;?> <b><?php echo $username;?></b> <a href="logout.php"><b><font color=blue>Logout</font></b></a>
  </font>
</div></h1> 
</body>
<!-- <?php
